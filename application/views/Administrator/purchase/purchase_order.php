...
<div class="row" id="purchase">
	<div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;margin-bottom:5px;">
		<div class="row">
			...
			<div class="form-group">
				<label class="col-sm-2 control-label no-padding-right"> Memo No </label>
				<div class="col-sm-3">
					<input type="text" id="memo_no" name="memo_no" v-model="purchase.memo_no" style="height:26px;" placeholder="Memo No"/>
				</div>
			</div>
		...
		methods: {
			...
			async getPurchase() {
				await axios.post('/get_purchases', {
					...
					this.purchase.memo_no = purchase.PurchaseMaster_MemoNo;
